...
export default function InsightsPanel() {
  return (
    <Card className="border-none shadow-md gradient-earth">
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {insights.map((item, i) => (
            <div key={i} className="bg-background/10 backdrop-blur-sm rounded-lg p-4 border border-primary-foreground/10">
              <item.icon className="w-5 h-5 text-alert-warning mb-2" />
